  ...
  return (
    <div className="flex flex-col lg:pl-20 gap-9 lg:gap-16 pt-16 pb-16">
      <div>
        <p
          id="testimonytitle"
          className="font-medium text-[35px] lg:text-[50px] text-center"
        >
          Testimonies
        </p>
      </div>
      <div className="flex flex-col lg:flex-row items-center justify-between gap-16 lg:overflow-x-hidden lg:hover:overflow-x-scroll">
        {testimony.map((testimony) => (
          <div
            key={testimony.id}
            className=" bg-[whitesmoke] w-[90%] lg:w-fit flex flex-col gap-10 p-6"
          >
            ...
            <div>
              <BiSolidQuoteLeft className="text-[#7C6A46]" />
              <p className="w-[100%] lg:w-[414px] text-center text-[13px] lg:text-[15px]">
                {" "}
                {testimony.text}
              </p>
              <BiSolidQuoteRight className="text-[#7C6A46]" />
            </div>
